package com.zhao.ad.search.index;

import com.alibaba.fastjson.JSON;
import com.zhao.ad.common.dump.DConstant;
import com.zhao.ad.common.dump.table.*;
import com.zhao.ad.search.constants.OpType;
import com.zhao.ad.search.handler.AdLevelHandler;
...
public class IndexFileLoader {
    ...
    public void init() {
        ...
        adPlanStrings.forEach(p -> AdLevelHandler.handleLevel2(
        ...
        adCreativeStrings.forEach(c -> AdLevelHandler.handleLevel2(
        ...
        adUnitStrings.forEach(u -> AdLevelHandler.handleLevel3(
        ...
        adCreativeUnitStrings.forEach(cu -> AdLevelHandler.handleLevel3(
        ...
        adUnitDistrictStrings.forEach(d -> AdLevelHandler.handleLevel4(
        ...
        adUnitItStrings.forEach(i -> AdLevelHandler.handleLevel4(
        ...
        adUnitKeywordStrings.forEach(k -> AdLevelHandler.handleLevel4(
                JSON.parseObject(k, AdUnitKeywwordTable.class),
                OpType.ADD
        ));
    }
